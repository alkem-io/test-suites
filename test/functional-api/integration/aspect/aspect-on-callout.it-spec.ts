...
describe('Aspects - Update', () => {
  beforeAll(async () => {
    const resAspectonHub = await createAspectOnCallout(
      ...
      { displayName: aspectDisplayName + 'forUpdates' }
    );
    hubAspectId = resAspectonHub.body.data.createAspectOnCallout.id;
  ...
  test('HM should NOT update aspect created on hub callout from GA', async () => {
    ...
    const resAspectonHub = await updateAspect(
      hubAspectId,
      aspectNameID,
      { displayName: aspectDisplayName + 'EM update' },
      AspectTypes.KNOWLEDGE,
      TestUser.HUB_MEMBER
    );
  ...
  test('NON-HM should NOT update aspect created on hub callout from GA', async () => {
    ...
    const resAspectonHub = await updateAspect(
      ...
      { displayName: aspectDisplayName + 'Non-EM update' },
      AspectTypes.KNOWLEDGE,
      TestUser.NON_HUB_MEMBER
    );
  ...
  test('HA should update aspect created on hub callout from GA', async () => {
    ...
    const resAspectonHub = await updateAspect(
      ...
      { displayName: aspectDisplayName + 'HA update' },
      AspectTypes.KNOWLEDGE,
      TestUser.HUB_ADMIN
    );
  ...
  test('GA should update aspect created on hub callout from GA', async () => {
    ...
    const resAspectonHub = await updateAspect(
      ...
      { displayName: aspectDisplayName + 'GA update' },
      AspectTypes.KNOWLEDGE,
...
test('HM should update aspect created on hub callout from HM', async () => {
  ...
  const resAspectonHubEM = await createAspectOnCallout(
    ...
    { displayName: `asp-nid-up-em${uniqueId}` },
  ...
  const resAspectonHub = await updateAspect(
    ...
    { displayName: aspectDisplayName + 'HM update' },
    AspectTypes.ACTOR,
    TestUser.HUB_MEMBER
  );
