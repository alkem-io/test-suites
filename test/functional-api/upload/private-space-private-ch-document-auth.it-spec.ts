...
describe('Private Space - Private Challenge - visual on profile', () => {
  describe.only('Access to Space Profile visual', () => {
    ...
    beforeAll(async () => {
      ...
      const a = await uploadImageOnVisual(
  ...
  describe.only('Access to Space Profile reference', () => {
    afterAll(async () => {
      await deleteDocument(documentId);
    });
    beforeAll(async () => {
  ...
  describe.only('Access to Space Context (space storage)', () => {
    afterAll(async () => {
      await deleteDocument(documentId);
    });
    beforeAll(async () => {
  ...
  describe.only('Access to Call for Whitaboards Whiteboard visual(banner) documents', () => {
    let calloutId: string;
  ...
  describe.only('Access to Call for Posts Callout reference documents', () => {
    let calloutId: string;
  ...
  describe.only('Access to Call for Posts Callout visual(banner) documents', () => {
    let calloutId: string;
  ...
  describe.only('Access to Whiteboard Callout visual(banner) documents', () => {
    let calloutId: string;
