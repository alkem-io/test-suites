...
CREATE TABLE `challenge_lead` (
  ...
  PRIMARY KEY (`challengeId`,`organizationId`),
  KEY `IDX_f457c1ae9eea70a87435cac56d` (`challengeId`),
  KEY `IDX_617eb0632402d30eb93e9a5f9e` (`organizationId`),
  CONSTRAINT `FK_617eb0632402d30eb93e9a5f9e2` FOREIGN KEY (`organizationId`) REFERENCES `organization` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `ecoverse` (
  ...
  CONSTRAINT `FK_84d2ecca9924fb1b0d2fe2d2ad6` FOREIGN KEY (`hostId`) REFERENCES `organization` (`id`),
...
CREATE TABLE `user_group` (
  ...
  CONSTRAINT `FK_2b8381df8c3a1680f50e4bc2351` FOREIGN KEY (`organizationId`) REFERENCES `organization` (`id`) ON DELETE SET NULL,
