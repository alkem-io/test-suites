...
//   JOIN_HUB_FROM_HOST_ORGANIZATION_MEMBERS = 'MEMBERSHIP_JOIN_SPACE_FROM_HOST_ORGANIZATION_MEMBERS',
//   ALLOW_MEMBERS_TO_CREATE_CHALLENGES = 'ALLOW_MEMBERS_TO_CREATE_CHALLENGES',
//   ALLOW_MEMBERS_TO_CREATE_CALLOUTS = 'ALLOW_MEMBERS_TO_CREATE_CALLOUTS',
// }

// export enum ChallengePreferenceType {
//   ALLOW_CONTRIBUTORS_TO_CREATE_OPPORTUNITIES = 'ALLOW_CONTRIBUTORS_TO_CREATE_OPPORTUNITIES',
//   ALLOW_HUB_MEMBERS_TO_CONTRIBUTE = 'ALLOW_SPACE_MEMBERS_TO_CONTRIBUTE',
//   ALLOW_CONTRIBUTORS_TO_CREATE_CALLOUTS = 'ALLOW_CONTRIBUTORS_TO_CREATE_CALLOUTS',
//   ALLOW_NON_MEMBERS_READ_ACCESS = 'ALLOW_NON_MEMBERS_READ_ACCESS',
//   APPLY_CHALLENGE_FROM_HUB_MEMBERS = 'MEMBERSHIP_APPLY_CHALLENGE_FROM_SPACE_MEMBERS',
//   FEEDBACK_ON_CHALLENGE_CONTEXT = 'MEMBERSHIP_FEEDBACK_ON_CHALLENGE_CONTEXT',
//   JOIN_CHALLENGE_FROM_HUB_MEMBERS = 'MEMBERSHIP_JOIN_CHALLENGE_FROM_SPACE_MEMBERS',
// }
...
export const changePreferenceSpace = async (
  spaceID: string,
  type: SpacePreferenceType = SpacePreferenceType.AuthorizationAnonymousReadAccess,
  value: string,
...
export const changePreferenceChallenge = async (
  challengeID: string,
  type: ChallengePreferenceType = ChallengePreferenceType.MembershipApplyChallengeFromSpaceMembers,
  value: string,
  userRole: TestUser = TestUser.GLOBAL_ADMIN
) => {
  const requestParams = {
