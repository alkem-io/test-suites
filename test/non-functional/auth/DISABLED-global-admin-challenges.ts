...
describe('GlobalAdminChallenges - Create Mutation', () => {
  test.each`
    operation                      | expected
  ...
  `('GlobalAdminChallenges: $operation', async ({ operation, expected }) => {
...
describe('GlobalAdminChallenges - Update Mutation', () => {
  test.each`
    operation               | expected
...
describe('GlobalAdminChallenges - Assign / Remove Mutation', () => {
  test.each`
    operation                    | expected
...
describe('GlobalAdminChallenges - Event Mutation', () => {
  test.each`
    operation               | expected
...
describe('GlobalAdminChallenges - Grant/Revoke Mutation', () => {
  test.each`
    operation                     | expected
...
describe('GlobalAdminChallenges - Delete Mutation', () => {
  test.each`
    operation                  | expected
