...
describe('Private Challenge of Private hub', () => {
  ...
  describe('DDT role access to Community of private challenge', () => {
    ...
    `(
      'User: "$user", should have Community privileges: "$communityMyPrivileges" and Communication privileges: "$communicationMyPrivileges" and Members privileges "$memberUsersMyPrivileges" for private challenge of private hub',
      async ({
        user,
