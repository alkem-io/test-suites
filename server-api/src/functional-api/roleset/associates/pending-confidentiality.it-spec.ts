// 062-organization-user-associates — US7 / contract §6 + §11: the
// pending-applications/invitations confidentiality narrowing (READ → GRANT
// on both role-set types, R3) and the R4 authorization-reset runbook proof.
import {
  TestScenarioFactory,
  TestUser,
  TestUserManager,
