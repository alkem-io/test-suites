...
- In order to run the tests, execute the following command: `pnpm test:[TEST_TYPE]` where TEST_TYPE is `it`
  - To run specific suite: `pnpm test:[TEST_TYPE] ./test folder>/<test suite file>` (i.e. `pnpm test:it ./src/functional/integration/challenge/create-challenge.it-spec.ts`)
...
Run tests:
    ...
    - run all tests: `pnpm test:nightly`
    - run all tests from particular test suite area: `pnpm test:it ./src/functional-api/integration/challenge/`
    - run all tests for a test file: `pnpm test:it ./src/functional-api/integration/challenge/query-challenge-data.it-spec.ts`
...
- Run the command for this particular test file: `pnpm test:it ./src/functional/integration/challenge/query-challenge-data.it-spec.ts`
