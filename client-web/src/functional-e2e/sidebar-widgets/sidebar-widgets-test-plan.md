...
| ------------ | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US1-AS1..AS4 | `us1-default-rendering.spec.ts` | Per-tab default widget set (FR-009) renders in order for an invited Space member (`qaUser`) across the four canonical tab positions, including the generic `[Add Post, Apply/Join, Intention&Leads, Post Index]` default for a 4th+/custom tab.                 |
