 ...
 * - authentication-cookie-consent.spec.ts (cookie consent banner tests)
 * - authentication-restricted-access.spec.ts (restricted access & redirects)
 * - authentication-login.spec.ts (logout flows, error handling - already contains these)
 *
...
test.describe.skip(
  'DEPRECATED - Authentication Critical Flows (see new split files)',
  () => {
