...
const { test, setupAuthentication, teardownAuthentication } =
  createAuthenticatedSessionFixture({
    storageStateName: 'innovation-pack-seeding.example.json',
    cleanupAfterTests: process.env.cleanupAfterTests === 'true',
  });

const scenarioConfig: TestScenarioConfig = {
  name: 'seed-innovation-pack-with-templates',
  organization: {
  ...
  innovationPack: {
    ...
    templates: [
      { type: 'WHITEBOARD' as any, profileDisplayName: 'WB Template A' },
      {
        type: 'POST' as any,
      ...
      {
        type: 'CALLOUT' as any,
        profileDisplayName: 'Callout (Link Framing, Multi-type Responses)',
        calloutFramingType: 'LINK',
        calloutResponseTypes: ['LINK'],
        calloutAllowedContributors: 'MEMBERS',
        // Optional: customize the link framing URI
        calloutLinkFramingUri: 'https://example.com/resources/detailed-guide',
      },
      {
        type: 'CALLOUT' as any,
        profileDisplayName: 'Callout (Whiteboard Framing, Memo Response Types)',
  ...
  // ========== Virtual Contributors Configuration ==========
  // Optional: create Virtual Contributors hosted by an organization
  virtualContributors: {
    useBaseOrganization: true,
    hostOrganization: {
      about: { profile: { displayName: 'VC Host Organization - Example' } },
      verification: { setVerified: true },
    },
    visibility: { listedInStore: true, searchVisibility: 'PUBLIC' },
    virtualContributors: [
      {
        ...
        profileDescription:
          'An expert assistant to help with complex questions',
        nameID: 'expert-assistant-01',
        aiPersona: {
          engine: 'OPENAI_ASSISTANT',
          prompt: ['You are an expert in technology and innovation.'],
        },
        bodyOfKnowledgeType: 'ALKEMIO_KNOWLEDGE_BASE',
        dataAccessMode: 'SPACE_PROFILE',
      },
    ],
  },
  // ========== Platform Discussion (optional) ==========
  platformDiscussion: {
